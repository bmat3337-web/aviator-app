  ...
  const render = () => {
    ...
    const betCard = (id: SlotId) => {
      ...
      return '<section class="bet-card '+(active ? "is-active" : "")+'">' +
        ...
        '<div class="quick-stakes"><button type="button" data-quick="'+id+':0.1">0.10</button><button type="button" data-quick="'+id+':0.2">0.20</button><button type="button" data-quick="'+id+':100">100</button><button type="button" data-quick="'+id+':500">500</button></div>' +
