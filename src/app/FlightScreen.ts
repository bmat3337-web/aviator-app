  ...
  const render = () => {
    ...
    const betCard = (id: SlotId) => {
      ...
      return '<section class="bet-card '+(active ? "is-active" : "")+'">' +
        ...
        '<div class="stake-control"><button type="button" data-step="'+id+':-10" aria-label="Decrease stake">−</button><output>'+stake[id].toFixed(2)+'</output><button type="button" data-step="'+id+':10" aria-label="Increase stake">+</button></div>' +
        '<div class="quick-stakes"><button type="button" data-quick="'+id+':10">10</button><button type="button" data-quick="'+id+':50">50</button><button type="button" data-quick="'+id+':100">100</button><button type="button" data-quick="'+id+':500">500</button></div>' +
